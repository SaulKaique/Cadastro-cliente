              ...
              <div class="row">
                 <h1>Dados do Cliente</h1>
                  ...
                  <div class="col-5 espaco">
                    ...
                    <div class="col-5 espaco">
                      <input type="text"  name="cep" id="cep" class="form-control" placeholder="CEP" aria-label="Last name">
                </div>
                <div class="col-4 espaco">
                  <input    type="text" name="telefone"  id="telefone" class="form-control" placeholder="Telefone" aria-label="Last name">
            </div>
            <div class="col-6 espaco">
              <input type="text" name="cpf" id="cpf" class="form-control" placeholder="CPF" aria-label="Last name">
          </div>
          <div class="col-6 espaco">
